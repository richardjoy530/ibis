      ...
      Container(
        ...
        child: Row(
          ...
          children: <Widget>[
            Text(
              'History',
              style: TextStyle(fontSize: 24.0, fontWeight: FontWeight.bold,color:Color(0xff02457a)),
            ),
            DropdownButton<String>(
              value: rooms.length == 0 ? 'No rooms' : dropdownValue,
              icon: Icon(Icons.arrow_drop_down,color: Color(0xff02457a),),
              iconSize: 30,
              elevation: 26,
              style: TextStyle(color: Color(0xff02457a),fontSize: 20.0),
              underline: Container(
                height: 0,
